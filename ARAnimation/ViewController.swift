...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func loadAnimations () {
        ...
        let idleScene = SCNScene(named: "art.scnassets/plane/plane_main_main.dae")!
...
//        loadAnimation(withKey: "dancing", sceneName: "art.scnassets/plane_main", animationIdentifier: "twist_danceFixed-1")
    }
